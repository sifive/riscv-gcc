...
/*
** test_sf_vfnrclip_x_f_qf_masked_vint8mf8_t:
** ...
** sf\.vfnrclip\.x\.f\.qf\tv[0-9]+,v[0-9]+,fa[0-9]+,v0.t
** ...
*/
vint8mf8_t test_sf_vfnrclip_x_f_qf_masked_vint8mf8_t(vbool64_t mask, vfloat32mf2_t vs2, float rs1, size_t vl) {
    return __riscv_sf_vfnrclip_x_f_qf_m(mask, vs2, rs1, vl);
}

/*
** test_sf_vfnrclip_x_f_qf_masked_vint8mf4_t:
** ...
** sf\.vfnrclip\.x\.f\.qf\tv[0-9]+,v[0-9]+,fa[0-9]+,v0.t
** ...
*/
vint8mf4_t test_sf_vfnrclip_x_f_qf_masked_vint8mf4_t(vbool32_t mask, vfloat32m1_t vs2, float rs1, size_t vl) {
    return __riscv_sf_vfnrclip_x_f_qf_m(mask, vs2, rs1, vl);
}

/*
** test_sf_vfnrclip_x_f_qf_masked_vint8mf2_t:
** ...
** sf\.vfnrclip\.x\.f\.qf\tv[0-9]+,v[0-9]+,fa[0-9]+,v0.t
** ...
*/
vint8mf2_t test_sf_vfnrclip_x_f_qf_masked_vint8mf2_t(vbool16_t mask, vfloat32m2_t vs2, float rs1, size_t vl) {
    return __riscv_sf_vfnrclip_x_f_qf_m(mask, vs2, rs1, vl);
}

/*
** test_sf_vfnrclip_x_f_qf_masked_vint8m1_t:
** ...
** sf\.vfnrclip\.x\.f\.qf\tv[0-9]+,v[0-9]+,fa[0-9]+,v0.t
** ...
*/
vint8m1_t test_sf_vfnrclip_x_f_qf_masked_vint8m1_t(vbool8_t mask, vfloat32m4_t vs2, float rs1, size_t vl) {
    return __riscv_sf_vfnrclip_x_f_qf_m(mask, vs2, rs1, vl);
}
...
** ...
*/
vint8m2_t test_sf_vfnrclip_x_f_qf_masked_vint8m2_t(vbool4_t mask, vfloat32m8_t vs2, float rs1, size_t vl) {
    return __riscv_sf_vfnrclip_x_f_qf_m(mask, vs2, rs1, vl);
}
