...
static const riscv_ext_flag_table_t riscv_ext_flag_table[] =
{
  ...
  {"zvqdotq",   &gcc_options::x_riscv_zf_subext, MASK_ZVQDOTQ},
  {"zvqwbdota8i", &gcc_options::x_riscv_zf_subext, MASK_ZVQWBDOTA8I},
  {"zvqwbdota16i", &gcc_options::x_riscv_zf_subext, MASK_ZVQWBDOTA16I},
  {"zvfwbdota16bf", &gcc_options::x_riscv_zf_subext, MASK_ZVFWBDOTA16BF},
  {"zvfqwbdota8f", &gcc_options::x_riscv_zf_subext, MASK_ZVFQWBDOTA8F},
  {"zvfbdota32f", &gcc_options::x_riscv_zf_subext, MASK_ZVFBDOTA32F},
