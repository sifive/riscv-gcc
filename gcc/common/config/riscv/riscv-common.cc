...
static const riscv_ext_flag_table_t riscv_ext_flag_table[] =
{
  ...
  {"zvqbdot8i", &gcc_options::x_riscv_zf_subext, MASK_ZVQBDOT8I},
  {"zvqbdot16i", &gcc_options::x_riscv_zf_subext, MASK_ZVQBDOT16I},
  {"zvfwbdot16bf", &gcc_options::x_riscv_zf_subext, MASK_ZVFWBDOT16BF},
  {"zvfqbdot8f", &gcc_options::x_riscv_zf_subext, MASK_ZVFQBDOT8F},
  {"zvfbdot32f", &gcc_options::x_riscv_zf_subext, MASK_ZVFBDOT32F}, 
