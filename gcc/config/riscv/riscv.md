...
(define_attr "type"
  "unknown,branch,jump,jalr,ret,call,load,fpload,store,fpstore,
   ...
   ghost,bitmanip,rotate,clmul,min,max,minu,maxu,clz,ctz,cpop,shnadd,
   ...
   vsha2ms,vsha2ch,vsha2cl,vsm4k,vsm4r,vsm3me,vsm3c,vfncvtbf16,vfwcvtbf16,vfwmaccbf16,ssci"
...
(define_attr "tune"
  "generic,sifive_7,sifive_7n,sifive_p400,sifive_p600,xiangshan,generic_ooo"
...
(define_insn "la<mode>_got_gprel"
  [(set (match_operand:P 0 "register_operand" "=&r")
	(match_operand:P 2 "symbolic_operand" ""))
   (use (match_operand:P 1 "register_operand" "r"))]
  "COMPACT_CMODEL_P"
  "la.got.gprel\t%0,%2,%1"
  [(set_attr "type" "multi")
   (set_attr "mode" "<MODE>")])
