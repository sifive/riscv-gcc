...
const pass_data pass_data_insert_func_sig_late =
{
  GIMPLE_PASS, /* type.  */
  "func_sig_late", /* name.  */
  OPTGROUP_NONE, /* optinfo_flags.  */
...
class pass_insert_func_sig_late : public gimple_opt_pass
{
public:
  pass_insert_func_sig_late (gcc::context *ctxt)
    : gimple_opt_pass (pass_data_insert_func_sig_late, ctxt)
  {}

  /* opt_pass methods: */
  virtual bool gate (function *)
    {
      return (!in_lto_p && is_zicfilp_p ());
    }

  virtual unsigned int execute (function *fun)
    {
      return rest_of_insert_func_sig (fun);
    }
}; // class pass_insert_func_sig_late

} // anon namespace

gimple_opt_pass *
make_pass_insert_func_sig_late (gcc::context *ctxt)
{
  return new pass_insert_func_sig_late (ctxt);
}
