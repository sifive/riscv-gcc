...
/* This pass implements forward-CFI landing pad checks for RISCV. This is
   ...
   This pass is triggered by the command line option -mzicfilp,
   which indicates the landing-pad label width of 1/2/3 byte-ish
   components, or 9/17/25 bits, respectively.  Since all the Zicfilp
   instructions are in the Zimop encoding space, this pass does not
